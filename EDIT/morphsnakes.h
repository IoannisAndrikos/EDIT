#pragma once
#ifndef MORPHSNAKES_H
#define MORPHSNAKES_H
...
namespace morphsnakes
{
	...
	{
	public:
		MorphACWE(const Embedding<D>& embedding, const NDImage<T, D>& image, int smoothing = 0, double lambda1 = 1.0, double lambda2 = 1.0)
